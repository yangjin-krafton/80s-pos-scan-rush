...
**결과**
- `src/sound/sfx_gen.py`는 WAV 마스터를 `src/assets/sfx_wav/`에 출력
- `src/sound/sfx_encode.py`가 WAV → `.m4a(AAC 96kbps mono)`로 변환 후 WAV 삭제

**확인 포인트**
- `python3 src/sound/sfx_gen.py` → `src/assets/sfx_wav/*.wav` 생성
- `python3 src/sound/sfx_encode.py` → `src/assets/sfx/*.m4a` 생성 + WAV 자동 삭제

**관련 파일**
- `src/sound/sfx_gen.py`
- `src/sound/sfx_encode.py`
